...
const { getPatientName, getUpcomingSessions, getMedicationsList, getPastAppointments, trackSymptoms, getSymptomsHistory } = require('../controllers/patientindexController');
